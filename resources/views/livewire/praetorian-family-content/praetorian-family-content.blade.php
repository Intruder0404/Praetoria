<div class="shrink-0 flex items-center justify-center">
    ...
    <img src="{{ asset('images/logo/octavii-1-transparent.png') }}" alt="octavii logo" width="500">
    ...
    @else
    <img src="{{ asset('images/logo/praetoria-1-transparent.png') }}" alt="praetorian logo" width="500">
    @endif
</div>
